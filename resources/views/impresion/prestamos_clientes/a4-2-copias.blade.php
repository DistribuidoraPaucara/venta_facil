...
<body>
    ...
    $estadoClass = 'Estado: PARCIALMENTE DEVUELTO';
    } else {
    ...
    <div class="page">
        <!-- COPIA 1 -->
        <div class="copia">
            <div style="padding-right: 5px !important; padding-left: 0px !important;">
                <!-- Header -->
                <div class="header">
        ...
        <!-- COPIA 2 (Idéntica) -->
        <div class="copia">
            <div style="padding-right: 8px !important; padding-left: 4px !important;">
                <!-- Header -->
                <div class="header">
                    <h3>Préstamo # <strong>{{ $documento->id }}</strong></h3>
                    <p>PRÉSTAMO DE CANASTILLAS / EMBASES</p>
