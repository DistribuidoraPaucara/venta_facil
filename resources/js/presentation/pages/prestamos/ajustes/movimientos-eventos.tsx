...
export default function MovimientosEventos() {
    ...
    const cargarMovimientos = useCallback(async () => {
        ...
        try {
            ...
            params.append('categoria', 'evento');
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Préstamos', href: '/prestamos' }, { title: 'Movimientos de Eventos', href: '/prestamos/ajustes/movimientos/eventos' }]}>
            <Head title="Movimientos de Stock - Eventos" />

            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                {/* Header */}
                <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">🎉 Movimientos de Stock - Eventos</h1>
                        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                            Registro de todos los préstamos a eventos: disponibilidad y daños
                        </p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="DEVOLUCION_EVENTO">Devolución Evento</option>
                    ...
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="border-b border-slate-200 bg-slate-50 dark:border-slate-700 dark:bg-slate-900">
                                ...
                                <th className="px-4 py-3 text-center font-semibold text-slate-900 dark:text-slate-100">Evento Antes</th>
                                ...
                                <th className="px-4 py-3 text-center font-semibold text-slate-900 dark:text-slate-100">Evento Después</th>
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3 text-center text-sm">
                                                <span className="font-medium text-orange-700 dark:text-orange-400">
                                                    {movimiento.prestamo_evento_anterior ?? 0}
                                                </span>
                                            </td>
