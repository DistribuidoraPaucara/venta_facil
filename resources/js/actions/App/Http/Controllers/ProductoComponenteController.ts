 ...
 * @route '/api/productos/{producto}/componentes/disponibles'
 */
    const productosDisponiblesForm = (args: { producto: string | number } | [producto: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: productosDisponibles.url(args, options),
        method: 'get',
    })
 ...
 * @route '/api/productos/{producto}/componentes/disponibles'
 */
        productosDisponiblesForm.get = (args: { producto: string | number } | [producto: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: productosDisponibles.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/productos/{producto}/componentes/disponibles'
 */
        productosDisponiblesForm.head = (args: { producto: string | number } | [producto: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: productosDisponibles.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
