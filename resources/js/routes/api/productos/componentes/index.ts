 ...
 */
export const disponibles = (args: { producto: string | number } | [producto: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/api/productos/{producto}/componentes/disponibles'
 */
disponibles.url = (args: { producto: string | number } | [producto: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { producto: args }
    }
 ...
 * @route '/api/productos/{producto}/componentes/disponibles'
 */
disponibles.get = (args: { producto: string | number } | [producto: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: disponibles.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/api/productos/{producto}/componentes/disponibles'
 */
disponibles.head = (args: { producto: string | number } | [producto: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: disponibles.url(args, options),
    method: 'head',
})
const componentes = {
