...
return new class extends Migration
{
    ...
    {
        Schema::create('prestamo_evento_almacenes', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['prestamo_evento_detalle_id', 'almacenes_prestables_id']);
    ...
    {
        Schema::dropIfExists('prestamo_evento_almacenes');
    }
};
